...
def search_employee():
    if searchEntry.get()=='':
        ...
        for employees in searched_data:
...
window.title('Roll Call System')
window.configure(fg_color='#161C30')
logo=CTkImage(Image.open('image1.jpg'),size=(930,158))
...
updateButton.grid(row=0,column=3,pady=5,padx=5)
